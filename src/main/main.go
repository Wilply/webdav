...
func init() {
	...
	http.HandleFunc("/listuser", weblistuser)
	http.HandleFunc("/createuser", webcreateuser)
	http.HandleFunc("/deleteuser", webdeleteuser)
	http.HandleFunc("/updateuser", webupdateuser)
}
